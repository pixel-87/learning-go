...
Non-nil slices **always** have an underlying array, through it isn't always specified explicitly. To explicitly create a slice on top an array we can do:
...
`lowIndex`, `highIndex`, or *both* can be omitted to use the entire array on the side of the colon.
