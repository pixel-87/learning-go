...
- If there are two people, how many possible connnections exist between them?
- If you add a third, how many new connections are created with the rest?
