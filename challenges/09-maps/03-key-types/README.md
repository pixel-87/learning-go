...
Unfortunately, this approach becomes unwidely when adding data, as for any given outer key you must check if the inner map exists, and create it if needed:
...
When a Vietamese person visits the home page, incrementing (and possibly creating) the appropriate counter is a one-liner:
...
- [x] To use a struct directly as a key
- [ ] To nest maps
