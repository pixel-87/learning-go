...
Challenge: 05-the-errors-package
Chapter: 06-errors
...
Remember that it's conventional to return the "zero" values of all other return values when you return an non-nil error in Go.
