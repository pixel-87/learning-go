...
Challenge: 08-pointer-receiver-code
Chapter: 10-pointers
...
Fix the bug in the code so that the `setMessage` sets teh `message` field of the given email struct, and the new value persists outside the scope of the `setMessage` method.
